#
# Python program to print the Trinomial triangle (see https://en.wikipedia.org/wiki/Trinomial_triangle)
#
# Run with "py trinomial.py [arg]" command, where [arg] is the max height of printed triangle
# 
# trit_sim(length, total) function can be also used for finding all possible variations of (length) long lists 
